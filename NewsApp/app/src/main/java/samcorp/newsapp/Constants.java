...
public class Constants {
    ...
    public static final String NYT_US =
            "https://api.nytimes.com/svc/topstories/v2/national.json?limit=5&api-key=5b2d914db4d4426196093c430a9b319c";

    public static final String NYT_WORLD =
            "https://api.nytimes.com/svc/topstories/v2/world.json?limit=5&api-key=5b2d914db4d4426196093c430a9b319c";

    public static final String NYT_SPORTS =
            "https://api.nytimes.com/svc/topstories/v2/sports.json?page=0&api-key=5b2d914db4d4426196093c430a9b319c";

    public static final String NYT_OPINION =
            "https://api.nytimes.com/svc/topstories/v2/opinion.json?page=0&api-key=5b2d914db4d4426196093c430a9b319c";

    public static final String NYT_TECH =
            "https://api.nytimes.com/svc/topstories/v2/technology.json?page=0&api-key=5b2d914db4d4426196093c430a9b319c";

    public static final String NYT_MOVIES =
            "https://api.nytimes.com/svc/topstories/v2/movies.json?page=0&api-key=5b2d914db4d4426196093c430a9b319c";

    public static final String NYT_TRAVEL =
            "https://api.nytimes.com/svc/topstories/v2/travel.json?page=0&api-key=5b2d914db4d4426196093c430a9b319c";
